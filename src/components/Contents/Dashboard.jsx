...
const Dashboard = ({chartData,data}) => {
  ...
  const [calories,setCalories] = useState(parseInt(localStorage.getItem('calories')))
  ...
  return (
    <div className="dashboard-container">
     <div className="row-left">
        <CategoryCard imgSrc={yogaCatIcn} catInfo="25 Days, 20 Minutes/Day" categoryName="Beginner Yoga" path="/home/train-yoga/begginer-yoga" updateTime={updateTime} updateCalories={updateCalories}/>
        ...
        <div className="suggested-exercises">
          <h3 className='sugg-text'>Suggested Exercises</h3>
            <SuggestedExercise name="Plank" time="60s" exerciseIcn={plankIcn} path='/home/train-yoga/plank-pose' calorieCnt="67" updateTime={updateTime} updateCalories={updateCalories}/>
     ...
     <div className="row-right">
        <div className="mini-stats-container">
          ...
          <div className="stat-item-container">
            ...
            <MiniStatCard newId="" text={calories} imgSrc={calorieIcn}/>
            <MiniStatCard newId="smallIcn" text={time} imgSrc={clockIcn}/>
          </div>
