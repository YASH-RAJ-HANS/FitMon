...
const SuggestedExercise = ({exerciseIcn,name,path,time,calorieCnt,updateTime,updateCalories}) => {
  return (
    <div className="suggested-exercise-container">
        ...
        <Link to={path} updateTime={updateTime} updateCalories={updateCalories}><img className='small-icn-two' src={playIcn} alt="" /></Link>
    </div>
  )
}
